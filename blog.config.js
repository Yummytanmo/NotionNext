...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Wenxuan Wang', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '探索AI的无限可能', // 您的个人简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://yummytanmo.fun', // 网站地址
